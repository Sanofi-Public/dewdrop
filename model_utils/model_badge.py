"""
Modified version of the model just for the badge selection strategy
"""
...
from utils_data import MAX_DIST, NUM_EDGE_TYPE
...
class NN(pl.LightningModule):
            ...
            for i in range(self.num_blocks + 1):
                ...
                if compute_loss:
                    ...
                    if i == self.num_blocks and save_grad: 
                        ...
                        # save layer output (embedding)
                        return_dict['final_block_emb'] = block.extract(s, v, R_pred, T_pred, edge_type_ij)
    ...
    def training_step(self, train_batch, batch_idx):
        opt = self.optimizers()
        return_dict = self(
            train_batch, compute_loss=True, return_struct=False, is_train=True, skip_first=True, save_grad=False
        )
    ...
    def predict_step(self, pred_batch, batch_idx):
        ...
        return_dict = self(pred_batch, compute_loss=False, return_struct=True, is_train=False)
...
class E3NN(torch.nn.Module):
    ...
    def extract(self, s, v, R, T, edge_type_ij): 
         # embed edges
        edges_ij = self.embed_edge(edge_type_ij)
