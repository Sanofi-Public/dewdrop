...
class BayesianRidgeRegressor(LinearRegressor):
    ...
    def _prepare_batch(self, X):
        raise NameError("BayesianRidgeRegressor does not support batching. Use fit instead.")

    def _forward(self, X, *args, **kwargs):
        raise NameError("BayesianRidgeRegressor does not support forward method. Use predict instead.")
