...
def modify_dropout(obj):
    ...
    if isinstance(obj, tf.keras.layers.Dropout):
        if obj.__class__ == tf.keras.layers.SpatialDropout1D:
            ...
            obj.noise_shape = (None, None, 1, 1) if obj.data_format == "channels_first" else (None, 1, 1, None)
        elif obj.__class__ == tf.keras.layers.SpatialDropout3D:
            obj.noise_shape = (None, None, 1, 1, 1) if obj.data_format == "channels_first" else (None, 1, 1, 1, None)
