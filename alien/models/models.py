    ...
    def __init__(
        ...
        **kwargs,
        ...
        if val_data is not None:
            ...
            assert (val_X is None) and (
                val_y is None
            ), "Only pass (val_X,val_y) *or* val_data to Model constructor"
...
class EnsembleRegressor(EnsembleModel, CovarianceRegressor):
    ...
    @flatten_batch
    def joint_entropy(self, *args, n=None, epsilon=None, rel_epsilon=1e-4, **kwargs):
        n = n or self.ensemble_size
...
class Classifier(Model):
    ...
    def predict_class(self, *args, **kwargs):
        ...
        return self.predict(*args, **kwargs).argmax(-1)  # works for numpy and torch
...
class EnsembleClassifier(Classifier, EnsembleModel, EntropyModel):
    def predict_class_samples(self, *args, n=None, **kwargs):
        ...
        return self.predict_samples(*args, n=n, **kwargs).argmax(-1)  # works for numpy and torch
