...
from utils_data import MAX_DIST, cg_X0, sequence_to_feats
...
class data_process:
    ...
    def process_one(self, job, pdb_path=None, model_type=None, unique_chain_id=None):
        ...
        # ADD: using only pdb file information 
        if pdb_path is not None:
            ...
            # ADD: parse pdb_dict for information previous extracted from csv
    ...
    def pdb_to_tensor(self, pdb_name, path, chain_id, len_chain_1, model_type="ab", is_train=True, unique_chain_id=None):
        ...
        result_1 = pdb_to_data.process_pdb(path, chain_id=chain_1, unique_chain_id=unique_chain_id)

        # DEBUG
#         print("result_1: ", result_1)
#         print("path: ", path)
#         print("chain_id: ", chain_1)
        ...
        if chain_2:
            result_2 = pdb_to_data.process_pdb(path, chain_id=chain_2)
