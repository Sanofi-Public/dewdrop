...
def from_pdb_string(pdb_str: str, chain_id: Optional[str] = None, unique_chain_id: Optional[str] = None) -> Protein:
    ...
    # DEBUG 
    # print("unique_chain_ids: ", unique_chain_ids)
    # print("chain_id_mapping: ", chain_id_mapping)
