...
# ADDED: Add the defualt CG group to each residue 
# for res in cg_dict: 
#     cg_dict[res].append(("N", "CA", "C", "O"))
...
# for res in resnames: # ADDED: let't not get rid of UNK now 
